#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Football Quant OS - Ivory Coast vs Ecuador Complete Report"""
...
story.append(Paragraph("⚠️ 关键发现: 平局概率被市场严重低估！模型预测44.3% vs 市场隐含27.1%，Edge +17.2%", styles['Y']))
...
x12 = [['结果','市场赔率','隐含概率','模型预测','Edge','投注评级'],['科特迪瓦胜','2.53','39.5%','24.2%','-15.3% ❌','无价值'],['平局','3.05','32.8%','44.3%','+11.5% ✅','巨大价值！'],['厄瓜多尔胜','2.93','34.1%','31.5%','-2.6% ❌','无价值']]
...
t.setStyle(TableStyle([('BACKGROUND',(0,0),(-1,0),colors.HexColor('#e94560')),('TEXTCOLOR',(0,0),(-1,0),colors.whitesmoke),('FONTNAME',(0,0),(-1,-1),FONT),('FONTSIZE',(0,0),(-1,-1),8),('ALIGN',(0,0),(-1,-1),'CENTER'),('GRID',(0,0),(-1,-1),0.5,colors.HexColor('#dee2e6')),('TOPPADDING',(0,0),(-1,-1),5),('BOTTOMPADDING',(0,0),(-1,-1),5)]))
story.append(t); story.append(Spacer(1, 8))
story.append(Paragraph("💡 分析: -0.25盘口下，平局=科特迪瓦输半。由于平局概率极高，厄瓜多尔+0.25胜（含平局）概率约65%，市场只给54.1%，Edge +11%。", styles['B']))
story.append(Spacer(1, 10))
