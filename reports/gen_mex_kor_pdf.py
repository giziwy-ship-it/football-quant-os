...
# Read markdown file
md_path = r'D:\openclaw-workspace\football_quant_os\reports\MEX_KOR_2026WC_PREDICTION.md'
...
<head>
<meta charset="UTF-8">
<title>墨西哥 vs 韩国 | 2026 FIFA World Cup - 量化预测报告</title>
<style>
...
.speculative { background: #9c27b0; color: white; }
</style>
</head>
<body>
<div class="header-banner">
<h1>🇲🇽 墨西哥 vs 韩国 🇰🇷 | 2026 FIFA World Cup 小组赛</h1>
<p style="margin:5px 0 0 0; font-size:10pt;">Naga Quant System v5.2.0 | 多市场量化预测报告 | Bloomberg + Goldman + McKinsey Hybrid Style</p>
</div>
''' + html_body + '''
</body>
</html>'''
...
# Save HTML file
html_path = r'D:\openclaw-workspace\football_quant_os\reports\MEX_KOR_2026WC_PREDICTION.html'
...
pdf_path = r'C:\Users\Administrator\Desktop\墨西哥vs韩国_2026世界杯_量化预测报告.pdf'
chrome_path = r'C:\Program Files\Google\Chrome\Application\chrome.exe'

# Fallback paths for Chrome
chrome_paths = [
