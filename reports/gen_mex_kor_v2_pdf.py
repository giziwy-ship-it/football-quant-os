...
# Read markdown file
md_path = r'D:\openclaw-workspace\football_quant_os\reports\MEX_KOR_2026WC_V2_GROUPSTAGE.md'
...
<head>
<meta charset="UTF-8">
<title>墨西哥 vs 韩国 | 2026 FIFA World Cup 小组赛A组第2轮 - 量化预测报告（含积分形势）</title>
<style>
...
<p style="margin:5px 0 0 0; font-size:10pt;">Naga Quant System v5.2.1-GroupStage | 含积分形势修正 | Bloomberg + Goldman + McKinsey Hybrid Style</p>
</div>
''' + html_body + '''
</body>
</html>'''
...
# Save HTML file
html_path = r'D:\openclaw-workspace\football_quant_os\reports\MEX_KOR_2026WC_V2_GROUPSTAGE.html'
...
pdf_path = r'C:\Users\Administrator\Desktop\墨西哥vs韩国_小组赛第2轮_积分形势修正版.pdf'
